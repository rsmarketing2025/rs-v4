          ...
          <Card className="bg-slate-900/50 dark:bg-slate-900/50 light:bg-white border-slate-800 dark:border-slate-800 light:border-slate-200 backdrop-blur-sm">
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              <CardHeader className="pb-4">
                <TabsList className="grid w-full grid-cols-4 bg-slate-800/50 dark:bg-slate-800/50 light:bg-slate-100">
                  ...
                  <TabsTrigger value="business-managers" className="data-[state=active]:bg-slate-800 data-[state=active]:text-white">
              ...
              <CardContent className="p-6">
                ...
                <TabsContent value="business-managers" className="mt-0">
                  <BusinessManagersTab />
                </TabsContent>
              </CardContent>
            </Tabs>
