...
export function AppSidebar() {
  ...
  return <Sidebar className="bg-neutral-950 border-neutral-800">
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              {filteredMenuItems.map(item => <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild isActive={location.pathname === item.url} className="text-neutral-100 hover:text-white hover:bg-neutral-800 data-[state=active]:bg-neutral-700 data-[state=active]:text-white">
                    <a href={item.url}>
                      <item.icon />
      ...
      <SidebarFooter className="p-4 bg-neutral-900">
        ...
        <Button onClick={signOut} variant="outline" size="sm" className="w-full border-neutral-600 text-neutral-200 hover:bg-neutral-800">
