    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-medium text-white">Oferta</h3>
            <p className="text-sm text-neutral-400">
              Configure materiais e instruções para criação de ofertas
            </p>
          </div>
        </div>
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Adicione informações específicas sobre ofertas, instruções especiais, ou conhecimento que o agente deve ter..."
              className="bg-neutral-800 border-neutral-700 text-white resize-none"
              rows={6}
            />
            <p className="text-xs text-neutral-500">
