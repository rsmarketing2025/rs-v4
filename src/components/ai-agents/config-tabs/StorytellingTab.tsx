...
export const StorytellingTab: React.FC = () => {
  ...
  const triggerWebhook = async (data: any) => {
    try {
      ...
      const webhookUrl = "https://webhook-automatios-rsmtk.abbadigital.com.br/webhook/rag-rs-copy-storytelling";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="text-lg font-medium text-white">Storytelling</h3>
            <p className="text-sm text-neutral-400">
              Configure materiais e instruções para storytelling
            </p>
          </div>
        </div>
        ...
        <CardContent>
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Adicione informações específicas sobre storytelling, instruções especiais, ou conhecimento que o agente deve ter..."
              className="bg-neutral-800 border-neutral-700 text-white resize-none"
              rows={6}
            />
            <p className="text-xs text-neutral-500">
